<%@ Page Title="" Language="C#" MasterPageFile="~/Auction.Master" AutoEventWireup="true" CodeBehind="AdminProfile.aspx.cs" Inherits="AuctionWebsite.AdminProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="AdminProfile" style="width: 1440px; height: 1024px; position: relative; background: white">
  ...
  <div class="966534078780" style="width: 139px; height: 23px; left: 137px; top: 996px; position: absolute; color: white; font-size: 10px; font-family: Kyiv*Type Serif; font-weight: 350; word-wrap: break-word">+966 53 407 8780</div>
  ...
  <div class="Rectangle8" style="width: 400px; height: 333px; left: 419px; top: 348px; position: absolute; background: rgba(149, 149, 116, 0.16); border-radius: 60px"></div>
  <div class="Rectangle16" style="width: 400px; height: 333px; left: 972px; top: 348px; position: absolute; background: rgba(149, 149, 116, 0.16); border-radius: 60px"></div>
  <div class="NumberOfBidders" style="left: 449px; top: 500px; position: absolute; text-align: center; color: black; font-size: 36px; font-family: Kufam; font-weight: 400; word-wrap: break-word">Number of bidders</div>
  <div class="OnGoingBids" style="left: 1046px; top: 500px; position: absolute; text-align: center; color: black; font-size: 36px; font-family: Kufam; font-weight: 400; word-wrap: break-word">On going bids</div>
  ...
  <div class="Dashboard" style="width: 199px; height: 36px; left: -15px; top: 187px; position: absolute; text-align: center; color: black; font-size: 20px; font-family: Kufam; font-weight: 400; word-wrap: break-word">Dashboard</div>
  <div class="Rectangle30" style="width: 281px; height: 52px; left: 0px; top: 171px; position: absolute; background: rgba(255, 255, 255, 0.38)"></div>
</div>
</asp:Content>
