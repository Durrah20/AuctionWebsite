<%@ Page Title="" Language="C#" MasterPageFile="~/Auction.Master" AutoEventWireup="true" CodeBehind="Admin_notification.aspx.cs" Inherits="AuctionWebsite.Admin_notification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="AdminNotification" style="width: 1440px; height: 1024px; position: relative; background: white">
  ...
  <div class="Rectangle3" style="width: 1461px; height: 50px; left: -15px; top: 0px; position: absolute; background: #959574"></div>
  ...
  <div class="NoNotificationsYet" style="left: 532px; top: 536px; position: absolute; opacity: 0.55; text-align: center; color: black; font-size: 64px; font-family: Kufam; font-weight: 400; word-wrap: break-word">No Notifications Yet</div>
  ...
  <div class="Notifications" style="width: 199px; height: 36px; left: -11px; top: 429px; position: absolute; text-align: center; color: black; font-size: 20px; font-family: Kufam; font-weight: 400; word-wrap: break-word">Notifications</div>
  ...
  <div class="Rectangle30" style="width: 281px; height: 52px; left: 0px; top: 414.50px; position: absolute; background: rgba(255, 255, 255, 0.38)"></div>
  &nbsp;<div class="FiRsUserRemove" style="width: 24px; height: 24px; padding-right: 0.04px; left: 1386px; top: 18px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
